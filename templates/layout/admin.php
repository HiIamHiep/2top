...
<html
    ...
    data-assets-path="/webroot/assets_admin/"
...
<head>
    ...
    <title><?php global $metaTitleMantan;
        echo $metaTitleMantan; ?></title>

    <meta name="description" content=""/>

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="/webroot/assets_admin/img/favicon/favicon.ico"/>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="/webroot/assets_admin/vendor/css/core.css" class="template-customizer-core-css"/>
    <link rel="stylesheet" href="/webroot/assets_admin/vendor/css/theme-default.css"
          class="template-customizer-theme-css"/>
    <link rel="stylesheet" href="/webroot/assets_admin/css/demo.css"/>
    <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet"/>
    <script src="/webroot/assets_admin/js/helper.js"></script>
    ...
    <!-- Helpers -->
    <script src="/webroot/assets_admin/vendor/js/helpers.js"></script>

    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="/webroot/assets_admin/js/config.js"></script>
</head>
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Mantan</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <?php if ($infoAdmin->type == 'boss' || in_array('posts', $infoAdmin->permission)) { ?>
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/posts/list" class="menu-link">
                                    <div>Bài viết</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/categories/post" class="menu-link">
                                    <div>Chuyên mục</div>
                                </a>
                            </li>
                        </ul>
                ...
                <?php if ($infoAdmin->type == 'boss' || in_array('albums', $infoAdmin->permission)) { ?>
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/albums/list" class="menu-link">
                                    <div>Danh sách</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/categories/album" class="menu-link">
                                    <div>Chuyên mục</div>
                                </a>
                            </li>
                        </ul>
                ...
                <?php if ($infoAdmin->type == 'boss' || in_array('videos', $infoAdmin->permission)) { ?>
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/videos/list" class="menu-link">
                                    <div>Danh sách</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/categories/video" class="menu-link">
                                    <div>Chuyên mục</div>
                                </a>
                            </li>
                        </ul>
                ...
                <?php if ($infoAdmin->type == 'boss' || in_array('themes', $infoAdmin->permission) || in_array('menus',
                        $infoAdmin->permission)) { ?>
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        if (!empty($menu)) {
                            ...
                            if (!empty($menu['sub'])) {
                                foreach ($menu['sub'] as $sub) {
                                    if (empty($sub['sub'])) {
                                        if ($infoAdmin->type == 'boss' || in_array($sub['permission'],
                                                $infoAdmin->permission)) {
                                  ...
                                  <ul class="menu-sub">';
                                        foreach ($sub['sub'] as $itemSub) {
                                            if ($infoAdmin->type == 'boss' || in_array($itemSub['permission'],
                                                    $infoAdmin->permission)) {
                                                echo '<li class="menu-item">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                               data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <img src="/webroot/assets_admin/img/avatars/1.png" alt
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <span
                                                    class="fw-semibold d-block"><?php echo $infoAdmin->fullName; ?></span>
                                ...
                                <li>
                                    <a class="dropdown-item" href="/admins/logout">
...
<?php if (!empty($mess)) { ?>
    <div class="modal fade" id="showMess" tabindex="-1" aria-hidden="true">
...
<!-- Vendors JS -->
<script src="/webroot/assets_admin/vendor/libs/apex-charts/apexcharts.js"></script>
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>


<!-- Main JS -->
<script src="/webroot/assets_admin/js/main.js"></script>

<!-- Page JS -->
<script src="/webroot/assets_admin/js/dashboards-analytics.js"></script>
